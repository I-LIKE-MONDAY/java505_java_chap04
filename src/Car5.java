...
//    초기화 하기 위한 생성자
    ...
    //    this() : 생성자가 자신의 다른 생성자를 호출하는 생성자
...
//    메소드 오버로딩 : 이름이 같은 메서드를 여러 개 선언하는 것
//    조건 : 매개변수의 타입, 개수, 순서 중 하나라도 다르면 됨.
//    메서드 오버로딩을 사용하는 이유 : 비슷한 기능을 제공하는 메서드를 여러 개 생성 시, 
//    각각 다른 이름을 제공하는 것보다 동일한 이름을 사용하는 것이 사용자가 사용하기 편리하기 때문
    public void getInfo() {
