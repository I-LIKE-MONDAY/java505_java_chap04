...
//        클래스 A의 value2는 default를 사용하여 다른 패키지에서 접근불가
//        a.value2 = 2000;   <-- 오류발생

//        클래스 A의 value3은 private를 사용하여 클래스 외부에서 접근 불가
//        a.value3 = 3000;   <-- 오류발생


        a.method1();
//        a.method2();      <-- 오류 발생 : 클래스 A의 method2() default를 사용하여 다른 패키지에서 접근불가
//        a.method3();      <-- 오류 발생 : 클래스 A의 method3() private를 사용하여 클래스 외부에서 접근 불가
